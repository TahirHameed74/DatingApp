    ...
    render() {
        return (
            <Menu tabular inverted size="tiny">
                ...
                {this.props.workerStatisticsMessages &&
                <Menu.Item name="users">
                    <Link style={{pointerEvents: "none"}}>
                        {`${this.props.workerStatisticsMessages.receivedCount} RECEIVED MESSAGE / ${this.props.workerStatisticsMessages.sentCount} SENT MESSAGE`}
                    </Link>
                </Menu.Item>
                }

                {this.props.moderatorInQueue &&
                <Menu.Item name="users">
                    <Link style={{pointerEvents: "none"}}>
                        {`QUEUE: ${this.props.moderatorInQueue.length}`}
                    </Link>
                </Menu.Item>
                }
