        ...
        case workersActionTypes.ADD_WORKER_MESSAGES_STATISTICS:
            return {
                ...
                workerStatisticsMessages: {
                    sentCount: state.workerStatisticsMessages.sentCount + action.data.sentCount,
                    receivedCount: state.workerStatisticsMessages.receivedCount + action.data.receivedCount
                },
            };
